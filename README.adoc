...
Poiji has a new documentation site. Documentation is available online at https://ozlerhakan.github.io/poiji/[ozlerhakan.github.io/poiji] and in the https://github.com/ozlerhakan/poiji-documentation[poiji-docs] repository.
