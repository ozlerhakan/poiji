...
public class DeserializersDateRegexTest {
    ...
    @Test
    public void successfulRegex() {

        try {
            PoijiOptions options = PoijiOptions.PoijiOptionsBuilder.settings().datePattern("yyyy-MM-dd").dateRegex("\\d{4}-\\d{2}-\\d{2}").build();
    ...
    public void failRegex() {
        ...
        try {
            PoijiOptions options = PoijiOptions.PoijiOptionsBuilder.settings().datePattern("yyyy-MM-dd").dateRegex("\\d{2}-\\d{2}-\\d{4}").build();
    ...
    public void dateFail() {
        ...
        try {
            PoijiOptions options = PoijiOptions.PoijiOptionsBuilder.settings().datePattern("MM/dd/yyyy").build();
    ...
    private static List<EmployeeExtended> unmarshalling() throws ParseException {
        ...
        employee1.setDate(sdf.parse("2017-01-05"));
        ...
        employee2.setDate((sdf).parse("2017-01-05"));
        ...
        employee3.setDate(sdf.parse("2017-01-05"));
