...
public final class DefaultExcelProperties {
    ...
    public static final String CREATED = "created";                 //java.util.Date
    public static final String CREATOR = "creator";                 //java.util.String
    public static final String DESCRIPTION = "description";         //java.util.String
    public static final String KEYWORDS = "keywords";               //java.util.String
    public static final String LAST_PRINTED = "lastPrinted";        //java.util.Date
    public static final String MODIFIED = "modified";               //java.util.Date
